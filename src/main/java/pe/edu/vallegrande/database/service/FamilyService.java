                ...
                return basicServiceRepository.findById(updatedFamily.getBasicServiceServiceId())
                    ...
                    .then(familyFeedingRepository.findById(updatedFamily.getFamilyFeedingId())
                        .flatMap(existingFamilyFeeding -> {
                            existingFamilyFeeding.setWeeklyFrequency(familyDTO.getFamilyFeeding().getWeeklyFrequency());
                            existingFamilyFeeding.setFeedingType(familyDTO.getFamilyFeeding().getFeedingType());
                    ...
                    .then(familyHealthRepository.findById(updatedFamily.getFamilyHealthId())
                        .flatMap(existingFamilyHealth -> {
                            ...
                            existingFamilyHealth.setDiseaseHistory(familyDTO.getFamilyHealth().getDiseaseHistory());
                            existingFamilyHealth.setMedicalExam(familyDTO.getFamilyHealth().getMedicalExam());
                    ...
                    .then(housingDistributionRepository.findById(updatedFamily.getHousingDistributionId())
                        .flatMap(existingHousingDistribution -> {
                            existingHousingDistribution.setHomeEnvironment(familyDTO.getHousingDistribution().getHomeEnvironment());
                            existingHousingDistribution.setBedroomNumber(familyDTO.getHousingDistribution().getBedroomNumber());
                            existingHousingDistribution.setHabitability(familyDTO.getHousingDistribution().getHabitability());
